...
## SGP
SGP(Simplified General Pertuberation) Models are mathamatical models that are used to calculate the orbital postion of satellites based on TLE data. I used a 

## Utility Class
![](./ReadmeAssets/Nadir.svg)<br/>
the Utility class is a wrapper for the SGP.NET  library for Unity that allowd me to make some easliy useable founctions that help convert stuff like geodesic cooridinates into Unity Vector 3 Postions. I also added additional methods such as the abilty to caluclate the Nadir point of a satellite on the surface of the earth.
